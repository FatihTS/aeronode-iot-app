...
export const mapClusters = [
  { id: 'c1', count: 3, status: 'normal', coords: [40.95, 29.65] },
  { id: 'c2', count: 3, status: 'normal', coords: [40.85, 30.55] },
  { id: 'c3', count: 3, status: 'normal', coords: [41.05, 30.7] },
  { id: 'c4', count: 2, status: 'low', coords: [40.6, 29.5] },
  { id: 'c5', count: 1, status: 'center', coords: [40.7, 30.05] },
  { id: 'c6', count: 2, status: 'critical', coords: [40.4, 30.45] },
  { id: 'c7', count: 3, status: 'normal', coords: [40.45, 30.0] },
]
